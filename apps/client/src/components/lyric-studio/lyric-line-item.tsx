...
export const LyricLineItem = memo(
	({
		...
		return (
			<div
				className={cn(
					'group relative rounded-lg border bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-all focus-within:ring-1 focus-within:ring-primary/30 overflow-hidden',
					{
